...
class Profile(models.Model):
    ...
    marks_aggr = models.IntegerField(default=0, validators=[MinValueValidator(0), MaxValueValidator(200)])
    rn = models.IntegerField(validators=[MinValueValidator(0)], null=True, blank=True, unique=True)
    pn = models.CharField(validators=[RegexValidator("^0?[5-9]{1}\d{9}$")], max_length=15, null=True, blank=True, unique=True)
    skills = models.TextField(null=True, blank=True)
    my_image = models.ImageField(upload_to="images\\", null=True)
